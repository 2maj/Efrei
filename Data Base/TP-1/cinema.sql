...
-- -------------------------------------------------
-- Se connecter a la BD cinema et executer le script
-- -------------------------------------------------
...
CREATE TABLE Film (
   ...
   PRIMARY KEY (ID_film),
   CONSTRAINT FK_Film_Artiste FOREIGN KEY(Nom_Realisateur) REFERENCES Artiste(Nom)
)Engine='InnoDb';
...
CREATE TABLE Role (
   ...
   CONSTRAINT FK_Role_Film FOREIGN KEY(ID_film) REFERENCES Film(ID_film),
   CONSTRAINT FK_Role_Artiste FOREIGN KEY(Nom_acteur) REFERENCES Artiste(Nom)
)Engine='InnoDb';
...
CREATE TABLE Salle (
   ...
   CONSTRAINT FK_Salle_Cinema FOREIGN KEY(Nom_cinema) REFERENCES Cinema(Nom_cinema)
)Engine='InnoDb';
...
CREATE TABLE Seance (
   ...
   CONSTRAINT FK_Seance_Salle FOREIGN KEY(Nom_cinema,No_salle) REFERENCES Salle(Nom_cinema,No_salle)
)Engine='InnoDb';
...
-- Penser a valider votre instantiation
